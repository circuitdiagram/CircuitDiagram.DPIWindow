...
namespace CircuitDiagram.DPIWindow
{
    /// <summary>
    /// Combines MahApps.MetroWindow with 
    /// </summary>
    public class MetroDPIWindow : MetroWindow
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets the current DPI for this window.
        /// </summary>
        public double CurrentDPI
        {
            get { return DpiInformation.MonitorDpiX.Value; }
        }
        ...
        /// <summary>
        /// Raised when the DPI of the window is changed.
        /// </summary>
        public event EventHandler DPIChanged;
    }
}
